...
////    ;
////    // for now for testing purpose initialize to flipped so we can see the card value 
////    // when actually playing game, new cards would all start false flipped 
////    this.flipped = true;
////  }
////
...
//  }
//
//  // initializes full deck then randomizes it 
//  ArrayList<Card> initializeDeck() {
//    ArrayList<Card> deck = new ArrayList<Card>();
//    ArrayList<Card> randomizedDeck = new ArrayList<Card>();
//    ArrayList<String> suits = new ArrayList<String>(Arrays.asList("♣", "♦", "♥", "♠"));
