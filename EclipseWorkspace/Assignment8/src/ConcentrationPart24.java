...
//    int cardIndex = 0;
//    TextImage score = new TextImage(Integer.toString(this.score), Color.black);
//
...
//    //
//    //      TimeUnit.SECONDS.sleep(2);
//    //      util.getFlippedCards(this.cards).get(0).changeFlipped(false);
//    //      util.getFlippedCards(this.cards).get(1).changeFlipped(false);
//    //    }
//
//  }
//
...
//
//    }
//    else if (util.getFlippedCards(this.cards).size() == 2) {
...
//  //   }
//  // }
//  // test sameRank method 
//  void testSameRank(Tester t) {
//    initCards();
//    //
//    //    t.checkExpect(c1.sameRank(c40), true);
//    //    t.checkExpect(c3.sameRank(c16), true);
//    //    t.checkExpect(c8.sameRank(c34), true);
//    //    t.checkExpect(c39.sameRank(c44), false);
//    //    t.checkExpect(c8.sameRank(c41), false);
//    //    t.checkExpect(c49.sameRank(c52), false);
//  }
//
//  // test sameRankCheck method 
...
//    cardWorldFull.placeImageXY(new TextImage("26", 13.0, Color.black), 300, 10);
//
