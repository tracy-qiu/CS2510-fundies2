...
//
//    if (matched) {
//      return new RectangleImage(30, 40, OutlineMode.SOLID, Color.white);
//    }
//
//    else if (flipped) {
...
//  }
//
//  // change the status of the card based on the input
//  void changeFlippedInput(boolean showCard) {
//    this.flipped = showCard;
//  }
//
//  // change the states of the matched field based on input
//  void changeMatchedInput(boolean match) {
//    this.matched = match;
//  }
//
//  // determines if two cards have the same rank and mutates
//  void sameRank(Card card2) {
//    if (sameRankCheck(card2)) {
//      this.matched = true;
//      card2.matched = true;
//      this.changeFlipped();
//      card2.changeFlipped();
...
//  }
//
//  // determines if two cards have the same rank and returns boolean
//  boolean sameRankCheck(Card card2) {
//    if (easyMode) {
//      return this.rank == (card2.rank);
//    }
//    else {
//      return this.matchSuitColors(card2) && this.rank == (card2.rank);
//    }
//  }
//
//  // determines if this card and the given card have the same suit and same color 
//  boolean matchSuitColors(Card card2) {
//    if (this.suit.equals("♠")
//        || this.suit.equals("♣") && (card2.suit.equals("♠") || card2.suit.equals("♣"))) {
//      return true;
//    }
...
//  }
//
//  boolean easyMode(CardWorld world) {
//    return world.easyMode;
//  }
//
//}
//
...
//  }
//
//  // test constructor for onTick (ending world)
//  CardWorld(ArrayList<Card> cards, int score) {
//    this.cards = cards;
//    this.score = score;
//    this.steps = 1;
//    this.easyMode = true;
...
//    int cardIndex = 0;
//    TextImage score = new TextImage("Score: " + Integer.toString(this.score), Color.black);
//    TextImage time = new TextImage("Time:    " + Integer.toString(this.time), Color.black);
//    TextImage stepsRemaining = new TextImage("Steps Remaining: " + Integer.toString(this.steps),
//        Color.black);
//    WorldImage prideFlag = new AboveAlignImage(AlignModeX.CENTER,
//        new RectangleImage(50, 7, OutlineMode.SOLID, Color.red),
//        new RectangleImage(50, 7, OutlineMode.SOLID, Color.orange),
//        new RectangleImage(50, 7, OutlineMode.SOLID, Color.yellow),
//        new RectangleImage(50, 7, OutlineMode.SOLID, Color.green),
//        new RectangleImage(50, 7, OutlineMode.SOLID, Color.blue),
//        new RectangleImage(50, 7, OutlineMode.SOLID, Color.magenta));
//    TextImage easyModeLabel = new TextImage("Easy Mode(match same rank) = green", Color.black);
//    TextImage hardModeLabel = new TextImage("Hard Mode(match same rank and same color) = red",
//        Color.black);
//    Color modeColor;
//    if (this.easyMode) {
...
//      modeColor = Color.red;
//    }
//    RectangleImage modeBox = new RectangleImage(30, 50, OutlineMode.SOLID, modeColor);
//
//    TextImage h = new TextImage("H", Color.red);
//    TextImage a = new TextImage("A", Color.orange);
//    TextImage p1 = new TextImage("P", Color.yellow);
//    TextImage p2 = new TextImage("P", Color.green);
//    TextImage y = new TextImage("Y", Color.blue);
//    TextImage p = new TextImage("P", Color.magenta);
//    TextImage r = new TextImage("R", Color.red);
//    TextImage i = new TextImage("I", Color.orange);
//    TextImage d = new TextImage("D", Color.yellow);
//    TextImage e = new TextImage("E", Color.green);
//    TextImage exclam = new TextImage("!", Color.blue);
//    TextImage exclam2 = new TextImage("!", Color.magenta);
//
...
//    }
//
//    cardWorld.placeImageXY(score, 300, 10);
//    cardWorld.placeImageXY(time, 85, 10);
//    cardWorld.placeImageXY(stepsRemaining, 120, 35);
//    cardWorld.placeImageXY(prideFlag, 520, 40);
//    cardWorld.placeImageXY(h, 250, 40);
//    cardWorld.placeImageXY(a, 260, 40);
//    cardWorld.placeImageXY(p1, 270, 40);
//    cardWorld.placeImageXY(p2, 280, 40);
//    cardWorld.placeImageXY(y, 290, 40);
//    cardWorld.placeImageXY(p, 300, 40);
//    cardWorld.placeImageXY(r, 310, 40);
//    cardWorld.placeImageXY(i, 320, 40);
//    cardWorld.placeImageXY(d, 330, 40);
//    cardWorld.placeImageXY(e, 340, 40);
//    cardWorld.placeImageXY(exclam, 350, 40);
//    cardWorld.placeImageXY(exclam2, 360, 40);
//    cardWorld.placeImageXY(modeBox, 85, 460);
//    cardWorld.placeImageXY(easyModeLabel, 230, 450);
//    cardWorld.placeImageXY(hardModeLabel, 270, 470);
//
//    return cardWorld;
//
//  }
//
//  // creates ending scene for the game
//  public WorldScene lastScene(String msg) {
//    WorldScene cardWorld = new WorldScene(600, 500);
//    TextImage end = new TextImage(msg, Color.black);
//
//    cardWorld.placeImageXY(end, 300, 250);
//
//    return cardWorld;
//  }
//
...
//    }
//
//    if (pos.x >= 55 && pos.x <= 115 && pos.y >= 410 && pos.y <= 510) {
//      for (Card c : cards) {
//        c.changeMode();
//      }
...
//  }
//
//  // state where no cards is flipped, one slipped, or two flipped
//  // can store them
//  public void onTick() {
//    Utils util = new Utils();
//
//    // if (util.getFlippedCards(this.cards).size() == 0) {
//    //
//    // }
//    // else if (util.getFlippedCards(this.cards).size() == 1) {
//    //
//    // }
//    if (util.getFlippedCards(this.cards).size() == 2) {
//      this.steps = this.steps - 1;
//      if (util.getFlippedCards(this.cards).get(0)
//          .sameRankCheck(util.getFlippedCards(this.cards).get(1))) {
//        this.score = this.score - 1;
//      }
//
//      util.getFlippedCards(this.cards).get(0).sameRank(util.getFlippedCards(this.cards).get(1));
//
//    }
//
//    if (this.score == 0) {
//      this.endOfWorld("Game Completed");
//    }
//
//    if (this.steps == 0) {
...
//    if (key.equals("r")) {
//      for (Card c : cards) {
//        c.changeFlippedInput(false);
//        c.changeMatchedInput(false);
//      }
//    }
//  }
//
...
//  ArrayList<Card> mt;
//  ArrayList<Card> endTestDeck;
//
//  CardWorld test1;
//  CardWorld test2;
//  CardWorld mainCardWorld;
//  CardWorld onTickEndTest;
//  CardWorld onTickGameOver;
//
//  CardWorld blank;
...
//    this.endTestDeck = new ArrayList<Card>(Arrays.asList(this.c1, this.c40));
//
//    this.test1 = new CardWorld(this.testDeck1);
//    this.test2 = new CardWorld(this.testDeck1, 1, 3);
//    this.blank = new CardWorld(this.mt);
//    this.mainCardWorld = new CardWorld(this.mainDeck);
//    this.onTickEndTest = new CardWorld(this.endTestDeck, 1);
//    this.onTickGameOver = new CardWorld(this.mainDeck, 26);
//
...
//  }
//
//  // test changeFlippedInput
//  void testChangeFlippedInput(Tester t) {
//
//    initCards();
//
//    t.checkExpect(this.card1.drawCard(),
//        new RectangleImage(30, 40, OutlineMode.SOLID, Color.black));
//    this.card1.changeFlippedInput(true);
//    t.checkExpect(this.card1.drawCard(),
//        new OverlayImage(new RectangleImage(30, 40, OutlineMode.OUTLINE, Color.black),
//            new TextImage(Integer.toString(5) + "♣", Color.black)));
//    this.card1.changeFlippedInput(false);
//    t.checkExpect(this.card1.drawCard(),
//        new RectangleImage(30, 40, OutlineMode.SOLID, Color.black));
//
//    t.checkExpect(this.card2.drawCard(),
//        new RectangleImage(30, 40, OutlineMode.SOLID, Color.black));
//    card2.changeFlippedInput(true);
//    t.checkExpect(this.card2.drawCard(),
//        new OverlayImage(new RectangleImage(30, 40, OutlineMode.OUTLINE, Color.black),
//            new TextImage(Integer.toString(6) + "♣", Color.black)));
//    card2.changeFlippedInput(false);
//    t.checkExpect(this.card2.drawCard(),
//        new RectangleImage(30, 40, OutlineMode.SOLID, Color.black));
//
//  }
//
//  // test changeMatchInput
//  void testChangeMatchInput(Tester t) {
//
//    initCards();
//
//    t.checkExpect(this.c1.matched, false);
//    this.c1.changeMatchedInput(true);
//    t.checkExpect(this.c1.matched, true);
//    this.c1.changeMatchedInput(false);
//    t.checkExpect(this.c1.matched, false);
//
//    t.checkExpect(this.c2.matched, false);
//    this.c2.changeMatchedInput(true);
//    t.checkExpect(this.c2.matched, true);
//    this.c2.changeMatchedInput(false);
//    t.checkExpect(this.c2.matched, false);
//
//  }
//
...
//
//    card1.changeFlipped();
//    t.checkExpect(this.card1.flipped, true);
//    card2.changeFlipped();
//    t.checkExpect(this.card2.flipped, true);
//    card3.changeFlipped();
//    t.checkExpect(this.card3.flipped, true);
//
//    this.card1.sameRank(card3);
//
//    t.checkExpect(this.card1.matched, true);
//    t.checkExpect(this.card3.matched, true);
//    t.checkExpect(this.card1.flipped, false);
//    t.checkExpect(this.card1.flipped, false);
//
//    initCards();
//
...
//    t.checkExpect(this.card2.flipped, true);
//
//    this.card1.sameRank(card2);
//
//    t.checkExpect(this.card1.flipped, false);
//    t.checkExpect(this.card2.flipped, false);
//
//    initCards();
//
//    c1.changeFlipped();
//    t.checkExpect(this.c1.flipped, true);
//    c40.changeFlipped();
//    t.checkExpect(this.c40.flipped, true);
//
//    this.c1.sameRank(c40);
//
//    t.checkExpect(this.c1.matched, true);
//    t.checkExpect(this.c40.matched, true);
//    t.checkExpect(this.c1.flipped, false);
//    t.checkExpect(this.c40.flipped, false);
//
//    initCards();
//
//    c10.changeFlipped();
//    t.checkExpect(this.c10.flipped, true);
//    c20.changeFlipped();
//    t.checkExpect(this.c20.flipped, true);
//
//    this.c10.sameRank(c20);
//
//    t.checkExpect(this.c10.flipped, false);
//    t.checkExpect(this.c20.flipped, false);
//
//  }
//
//  // test sameRankCheck
//  void testSameRankCheck(Tester t) {
//
//    initCards();
//
//    t.checkExpect(this.c1.sameRankCheck(c14), true);
//    t.checkExpect(this.c2.sameRankCheck(c15), true);
//    t.checkExpect(this.c20.sameRankCheck(c33), true);
//    t.checkExpect(this.c14.sameRankCheck(c7), false);
//    t.checkExpect(this.c38.sameRankCheck(c51), true);
//    t.checkExpect(this.c44.sameRankCheck(c45), false);
//    t.checkExpect(this.c35.sameRankCheck(c52), false);
//
//    t.checkExpect(c1.sameRankCheck(c40), true);
//    t.checkExpect(c3.sameRankCheck(c16), true);
//    t.checkExpect(c8.sameRankCheck(c34), true);
//    t.checkExpect(c39.sameRankCheck(c44), false);
//    t.checkExpect(c8.sameRankCheck(c41), false);
//    t.checkExpect(c49.sameRankCheck(c52), false);
//
//  }
//
...
//    Utils util = new Utils();
//
//    t.checkExpect(util.countFlipped(mt), 0);
//    t.checkExpect(util.countFlipped(mainDeck), 0);
//
//    c1.changeFlipped();
//    t.checkExpect(util.countFlipped(mainDeck), 1);
//    c2.changeFlipped();
//    t.checkExpect(util.countFlipped(mainDeck), 2);
//    c3.changeFlipped();
//    t.checkExpect(util.countFlipped(mainDeck), 3);
//    c4.changeFlipped();
//    t.checkExpect(util.countFlipped(mainDeck), 4);
//    c5.changeFlipped();
//    t.checkExpect(util.countFlipped(mainDeck), 5);
//    c6.changeFlipped();
//    t.checkExpect(util.countFlipped(mainDeck), 6);
//
//    initCards();
//
//    t.checkExpect(util.countFlipped(mainDeck), 0);
...
//    c50.flipped = true;
//    c29.flipped = true;
//    t.checkExpect(util.countFlipped(mainDeck), 8);
//
//    c1.flipped = false;
//    c2.flipped = false;
//    t.checkExpect(util.countFlipped(mainDeck), 6);
...
//  }
//
//  // test getFlippedCards
//  void testGetFlippedCards(Tester t) {
//
//    initCards();
//    Utils util = new Utils();
//
//    t.checkExpect(util.getFlippedCards(mt), mt);
//    t.checkExpect(util.getFlippedCards(mainDeck), mt);
//
//    c1.changeFlipped();
//    t.checkExpect(util.getFlippedCards(mainDeck), new ArrayList<Card>(Arrays.asList(this.c1)));
//    c2.changeFlipped();
//    t.checkExpect(util.getFlippedCards(mainDeck),
//        new ArrayList<Card>(Arrays.asList(this.c1, this.c2)));
//    c3.changeFlipped();
//    t.checkExpect(util.getFlippedCards(mainDeck),
//        new ArrayList<Card>(Arrays.asList(this.c1, this.c2, this.c3)));
//    c4.changeFlipped();
//    t.checkExpect(util.getFlippedCards(mainDeck),
//        new ArrayList<Card>(Arrays.asList(this.c1, this.c2, this.c3, this.c4)));
//    c5.changeFlipped();
//    t.checkExpect(util.getFlippedCards(mainDeck),
//        new ArrayList<Card>(Arrays.asList(this.c1, this.c2, this.c3, this.c4, this.c5)));
//    c6.changeFlipped();
//    t.checkExpect(util.getFlippedCards(mainDeck),
//        new ArrayList<Card>(Arrays.asList(this.c1, this.c2, this.c3, this.c4, this.c5, this.c6)));
//
//    initCards();
//
//    t.checkExpect(util.getFlippedCards(mainDeck), new ArrayList<Card>());
//
//    c1.flipped = true;
//    c2.flipped = true;
//    c9.flipped = true;
//    t.checkExpect(util.getFlippedCards(mainDeck),
//        new ArrayList<Card>(Arrays.asList(this.c1, this.c2, this.c9)));
//
//    c11.flipped = true;
//    c28.flipped = false;
//    c30.flipped = true;
//    t.checkExpect(util.getFlippedCards(mainDeck),
//        new ArrayList<Card>(Arrays.asList(this.c1, this.c2, this.c9, this.c11, this.c30)));
//
//    c42.flipped = true;
//    c51.flipped = true;
//    c9.flipped = false;
//    t.checkExpect(util.getFlippedCards(mainDeck), new ArrayList<Card>(
//        Arrays.asList(this.c1, this.c2, this.c11, this.c30, this.c42, this.c51)));
//
//    c50.flipped = true;
//    c29.flipped = true;
//    t.checkExpect(util.getFlippedCards(mainDeck), new ArrayList<Card>(Arrays.asList(this.c1,
//        this.c2, this.c11, this.c29, this.c30, this.c42, this.c50, this.c51)));
//
//    c1.flipped = false;
//    c2.flipped = false;
//    t.checkExpect(util.getFlippedCards(mainDeck), new ArrayList<Card>(
//        Arrays.asList(this.c11, this.c29, this.c30, this.c42, this.c50, this.c51)));
//  }
//
//  // test initializeDeck
...
//
//  // test matchSuitColor 
//  void testMatchSuitColor(Tester t) {
//    initCards();
//
//    t.checkExpect(c1.matchSuitColors(c49), true);
//    t.checkExpect(c15.matchSuitColors(c37), true);
//    t.checkExpect(c30.matchSuitColors(c34), true);
//    t.checkExpect(c50.matchSuitColors(c52), true);
//    t.checkExpect(c1.matchSuitColors(c48), true);
//    t.checkExpect(c12.matchSuitColors(c39), false);
//  }
//
//  // test changeMode 
//  void testChangeMode(Tester t) {
//    initCards();
//
//    c1.changeMode();
//    c3.changeMode();
//    c43.changeMode();
//    t.checkExpect(c1.easyMode, false);
//    t.checkExpect(c3.easyMode, false);
//    t.checkExpect(c43.easyMode, false);
//    t.checkExpect(c17.easyMode, true);
//    t.checkExpect(c29.easyMode, true);
//  }
//
//  // test makeScene
...
//    TextImage score = new TextImage("Score: " + Integer.toString(this.mainCardWorld.score),
//        Color.black);
//    TextImage time = new TextImage("Time:    " + Integer.toString(this.mainCardWorld.time),
//        Color.black);
//    TextImage stepsRemaining = new TextImage(
//        "Steps Remaining: " + Integer.toString(this.mainCardWorld.steps), Color.black);
//    RectangleImage modeBox = new RectangleImage(30, 50, OutlineMode.SOLID, Color.green);
//    TextImage easyModeLabel = new TextImage("Easy Mode(match same rank) = green", Color.black);
//    TextImage hardModeLabel = new TextImage("Hard Mode(match same rank and same color) = red",
//        Color.black);
//
...
//    cardWorldFull.placeImageXY(score, 300, 10);
//    cardWorldFull.placeImageXY(time, 85, 10);
//    cardWorldFull.placeImageXY(stepsRemaining, 120, 35);
//    cardWorldFull.placeImageXY(prideFlag, 520, 40);
//    cardWorldFull.placeImageXY(h, 250, 40);
//    cardWorldFull.placeImageXY(a, 260, 40);
//    cardWorldFull.placeImageXY(p1, 270, 40);
//    cardWorldFull.placeImageXY(p2, 280, 40);
//    cardWorldFull.placeImageXY(y, 290, 40);
//    cardWorldFull.placeImageXY(p, 300, 40);
//    cardWorldFull.placeImageXY(r, 310, 40);
//    cardWorldFull.placeImageXY(i, 320, 40);
//    cardWorldFull.placeImageXY(d, 330, 40);
//    cardWorldFull.placeImageXY(e, 340, 40);
//    cardWorldFull.placeImageXY(exclam, 350, 40);
//    cardWorldFull.placeImageXY(exclam2, 360, 40);
//    cardWorldFull.placeImageXY(modeBox, 85, 460);
//    cardWorldFull.placeImageXY(easyModeLabel, 230, 450);
//    cardWorldFull.placeImageXY(hardModeLabel, 270, 470);
//
...
//    initCards();
//    WorldScene cardWorld = new WorldScene(600, 500);
//    WorldScene cardWorld2 = new WorldScene(600, 500);
//    TextImage end = new TextImage("Game Completed", Color.black);
//    TextImage over = new TextImage("Game Over", Color.black);
//
//    cardWorld.placeImageXY(end, 300, 250);
//    cardWorld2.placeImageXY(over, 300, 250);
//
//    t.checkExpect(this.mainCardWorld.lastScene("Game Completed"), cardWorld);
//    t.checkExpect(this.test1.lastScene("Game Completed"), cardWorld);
//    t.checkExpect(this.test2.lastScene("Game Completed"), cardWorld);
//
//    t.checkExpect(this.mainCardWorld.lastScene("Game Over"), cardWorld2);
//    t.checkExpect(this.test1.lastScene("Game Over"), cardWorld2);
//    t.checkExpect(this.test2.lastScene("Game Over"), cardWorld2);
//
//  }
//
//  // test onMouseClicked
...
//    Utils util = new Utils();
//
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 0);
//    t.checkExpect(this.c1.flipped, false);
//    this.mainCardWorld.onMouseClicked(new Posn(50, 100));
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 1);
//    t.checkExpect(this.c1.flipped, true);
//
//    t.checkExpect(this.c2.flipped, false);
//    this.mainCardWorld.onMouseClicked(new Posn(90, 100));
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 2);
//    t.checkExpect(this.c2.flipped, true);
//
//    t.checkExpect(this.c3.flipped, false);
//    this.mainCardWorld.onMouseClicked(new Posn(130, 100));
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 2);
//    t.checkExpect(this.c3.flipped, false);
//
//    initCards();
//
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 0);
//    t.checkExpect(this.c13.flipped, false);
//    this.mainCardWorld.onMouseClicked(new Posn(530, 100));
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 1);
//    t.checkExpect(this.c13.flipped, true);
//
//    t.checkExpect(this.c29.flipped, false);
//    this.mainCardWorld.onMouseClicked(new Posn(130, 300));
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 2);
//    t.checkExpect(this.c29.flipped, true);
//
//    t.checkExpect(this.c36.flipped, false);
//    this.mainCardWorld.onMouseClicked(new Posn(410, 300));
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 2);
//    t.checkExpect(this.c36.flipped, false);
//
//    initCards();
...
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 0);
//    t.checkExpect(this.c1.flipped, false);
//    this.mainCardWorld.onMouseClicked(new Posn(525, 60));
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 0);
//    t.checkExpect(this.c1.flipped, false);
//
//  }
...
//
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 0);
//    this.mainCardWorld.onTick();
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 0);
//    // no change
//
//    this.c1.changeFlipped();
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 1);
//    t.checkExpect(this.c1.flipped, true);
//    this.mainCardWorld.onTick();
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 1);
...
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 1);
//    t.checkExpect(this.c2.flipped, false);
//    this.c2.changeFlipped();
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 2);
//    t.checkExpect(this.c2.flipped, true);
//    t.checkExpect(this.mainCardWorld.steps, 52);
//
//    this.mainCardWorld.onTick();
//
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 0);
//    t.checkExpect(this.c1.flipped, false);
//    t.checkExpect(this.c2.flipped, false);
//    t.checkExpect(this.mainCardWorld.score, 26);
//    t.checkExpect(this.mainCardWorld.steps, 51);
//    // change occurs when two cards are flipped (not same rank)
//
//    initCards();
//
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 0);
...
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 1);
//    t.checkExpect(this.c40.flipped, false);
//    this.c40.changeFlipped();
//    t.checkExpect(util.countFlipped(this.mainCardWorld.cards), 2);
//    t.checkExpect(this.c40.flipped, true);
//    t.checkExpect(this.c1.matched, false);
//    t.checkExpect(this.c40.matched, false);
//    t.checkExpect(this.mainCardWorld.steps, 52);
//
//    this.mainCardWorld.onTick();
//
...
//    t.checkExpect(this.c1.matched, true);
//    t.checkExpect(this.c40.matched, true);
//    t.checkExpect(this.mainCardWorld.score, 25);
//    t.checkExpect(this.mainCardWorld.steps, 51);
//    // change occurs, same rank
//
//    initCards();
//    WorldScene cardWorld = new WorldScene(600, 500);
//    TextImage end = new TextImage("Game Completed", Color.black);
//
//    t.checkExpect(this.onTickEndTest.score, 1);
//    this.c1.changeFlipped();
//    this.c40.changeFlipped();
//    t.checkExpect(util.countFlipped(this.onTickEndTest.cards), 2);
//
//    this.onTickEndTest.onTick();
//    t.checkExpect(util.countFlipped(this.onTickEndTest.cards), 0);
//    t.checkExpect(this.c1.flipped, false);
//    t.checkExpect(this.c40.flipped, false);
//    t.checkExpect(this.c1.matched, true);
//    t.checkExpect(this.c40.matched, true);
//    t.checkExpect(this.onTickEndTest.score, 0);
//
//    this.onTickEndTest.onTick();
//
//    cardWorld.placeImageXY(end, 300, 250);
//
//    t.checkExpect(this.onTickEndTest.lastScene("Game Completed"), cardWorld);
//
//    initCards();
//
//    WorldScene cardWorld2 = new WorldScene(600, 500);
//    TextImage end2 = new TextImage("Game Over", Color.black);
//
//    t.checkExpect(this.onTickGameOver.score, 26);
//    this.c1.changeFlipped();
//    this.c40.changeFlipped();
//    t.checkExpect(util.countFlipped(this.onTickGameOver.cards), 2);
//    t.checkExpect(this.onTickGameOver.steps, 1);
//
//    this.onTickGameOver.onTick();
//    t.checkExpect(util.countFlipped(this.onTickGameOver.cards), 0);
//    t.checkExpect(this.c1.flipped, false);
//    t.checkExpect(this.c40.flipped, false);
//    t.checkExpect(this.c1.matched, true);
//    t.checkExpect(this.c40.matched, true);
//    t.checkExpect(this.onTickGameOver.score, 25);
//    t.checkExpect(this.onTickGameOver.steps, 0);
//
//    this.onTickGameOver.onTick();
//
//    cardWorld2.placeImageXY(end2, 300, 250);
//
//    t.checkExpect(this.onTickGameOver.lastScene("Game Over"), cardWorld2);
//
//  }
//
//  // test onKeyEvent
...
//    t.checkExpect(this.c2.flipped, true);
//
//    this.mainCardWorld.onKeyEvent("r");
//    t.checkExpect(this.c1.flipped, false);
//    t.checkExpect(this.c2.flipped, false);
//    t.checkExpect(this.c1.matched, false);
//    t.checkExpect(this.c2.matched, false);
...
//    t.checkExpect(this.c2.flipped, true);
//
//    this.mainCardWorld.onKeyEvent("s");
//    t.checkExpect(this.c1.flipped, true);
//    t.checkExpect(this.c2.flipped, true);
//    t.checkExpect(this.c1.matched, false);
//    t.checkExpect(this.c2.matched, false);
...
//    t.checkExpect(this.c20.flipped, true);
//    c30.changeFlipped();
//    t.checkExpect(this.c30.flipped, true);
//    c40.changeFlipped();
//    t.checkExpect(this.c40.flipped, true);
//
//    this.mainCardWorld.onKeyEvent("r");
//    t.checkExpect(this.c10.flipped, false);
//    t.checkExpect(this.c20.flipped, false);
//    t.checkExpect(this.c30.flipped, false);
//    t.checkExpect(this.c40.flipped, false);
//    t.checkExpect(this.c10.matched, false);
//    t.checkExpect(this.c20.matched, false);
//    t.checkExpect(this.c30.matched, false);
//    t.checkExpect(this.c40.matched, false);
//    t.checkExpect(util.countFlipped(mainDeck), 0);
//
//    initCards();
...
//    t.checkExpect(this.c30.flipped, true);
//    c33.changeFlipped();
//    t.checkExpect(this.c33.flipped, true);
//
//    this.c20.sameRank(this.c33);
//    t.checkExpect(this.c10.matched, false);
//    t.checkExpect(this.c30.matched, false);
//    t.checkExpect(this.c20.matched, true);
//    t.checkExpect(this.c33.matched, true);
//    t.checkExpect(this.c20.flipped, false);
//    t.checkExpect(this.c33.flipped, false);
//
//    this.mainCardWorld.onKeyEvent("r");
//    t.checkExpect(this.c10.flipped, false);
//    t.checkExpect(this.c20.flipped, false);
...
//    t.checkExpect(this.c20.matched, false);
//    t.checkExpect(this.c30.matched, false);
//    t.checkExpect(this.c33.matched, false);
//    t.checkExpect(util.countFlipped(mainDeck), 0);
//
//    initCards();
//
...
//    t.checkExpect(this.c1.flipped, true);
//    c14.changeFlipped();
//    t.checkExpect(this.c14.flipped, true);
//
//    this.c1.sameRank(this.c14);
//
//    t.checkExpect(this.c1.matched, true);
//    t.checkExpect(this.c14.matched, true);
//
//    this.mainCardWorld.onKeyEvent("r");
//    t.checkExpect(this.c1.flipped, false);
//    t.checkExpect(this.c14.flipped, false);
//    t.checkExpect(this.c1.matched, false);
//    t.checkExpect(this.c14.matched, false);
//    t.checkExpect(util.countFlipped(mainDeck), 0);
//
//    initCards();
//
...
//    this.mainCardWorld.onKeyEvent("s");
//
//    // made false from same rank
//    t.checkExpect(this.c1.flipped, false);
//    t.checkExpect(this.c14.flipped, false);
//
//    // no change cause key is not "r"
//    t.checkExpect(this.c1.matched, true);
//    t.checkExpect(this.c14.matched, true);
//
//    // zero from same rank
