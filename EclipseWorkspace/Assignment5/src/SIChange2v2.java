...
//      startBullets);
//  SpaceInvaders smallWorld2 = new SpaceInvaders(this.player, this.smallAList, addpb, startBullets);
//
//  // BigBang
...
//  //           this.alienList, this.startBullets))
//  //       && t.checkExpect(this.smallWorld.onTick(),
//  //           new SpaceInvaders(new PlayerShip(new ShipPt(252, 450, true), Color.black, 50, 25),
//  //               this.smallAList, this.startBullets))
...
//  // Color.black, 50, 25), this.alienList, this.startBullets));
//  //
//  // }
//
